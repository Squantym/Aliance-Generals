...
(async () => {
  ...
  // Срок называть нельзя: самооткрытия после обнуления нет, и названный
  // срок стал бы обещанием, которое некому исполнить. Ровно так окно
  // провисело двое суток после обнуления 30.08.2026.
  ok('срок игрокам не обещан', !w.d.maintenance.until);
  ok('и самооткрытия нет', w.d.maintenance.auto === false);
