...
// Подписи выводятся через ::before как ТЕКСТ: картинку туда не
// подставить, а эмодзи монеты половина систем рисует пустым квадратом.
// Поэтому подписи словами.
ok('у ресурсных ячеек есть подписи data-l',
   ['$', 'зол.', 'герб', 'жет.'].every((lab) => js.includes('data-l="' + lab + '"')));
