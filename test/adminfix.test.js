...
function mkUser(id, name, isAdmin) {
  return {
    ...
    counters: { wins: 0, attacks: 0, breaches: 0, unitsBought: 0, buildingsBuilt: 0, missionStages: 7, crestsTorn: 0, moneyEarned: 0, battleLoot: 0, level: 20 },
...
eq('resetAccount: уровень 1 (полный сброс)', victim.level, 1);
