...
console.log('\n[4] Бонус за все поручения дня отменён');
// Раньше бонус рос с уровнем (150 → 300 🪙 в сутки) и доставался всякому,
// кто просто доиграл день до конца. Теперь дневного золота за «выполнил
// всё» нет, а недельный бонус — ровно 100 и от уровня не зависит.
eq('ур.1 дневного бонуса нет', c.dailyAllBonusGold(1), 0);
eq('ур.300 тоже нет', c.dailyAllBonusGold(300), 0);
eq('недельный бонус ровно 100', c.weeklyAllBonusGold(300), 100);
