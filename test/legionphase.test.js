...
function mkUser(id) {
  return { id, name: id, email: id + '@t.t', passHash: 'x', salt: 'x', country: 'ru', status: '', createdAt: now, lastSeen: now, level: 20, xp: 0, dollars: 0, gold: 0, bank: 0, skillPoints: 0, skills: { energy: 0, health: 0, ammo: 0, cruelty: 0, agility: 0 }, res: { hp: { cur: 100, max: 100, t: now }, en: { cur: 50, max: 100, t: now }, am: { cur: 7, max: 100, t: now } }, units: {}, buildings: {}, secretDevs: {}, superSecret: 0, ears: 0, tokens: 0, crestPartsLost: 0, crestParts: 2, crestLostAt: [], battle: { attacks: 0, wins: 0, losses: 0, defWins: 0, defLosses: 0, breaches: 0 }, counters: {}, trophies: {}, effects: [], allianceId: null, legionId: null, lastIncomeAt: now, saboteurs: { ground: 0, sea: 0, air: 0, secret: 0, building: 0, suicide: 0 }, saboteurLimits: { ground: 50, sea: 50, air: 50, secret: 50, building: 50 }, silos: [] };
}
