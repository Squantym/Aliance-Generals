...
const now = Date.now();
function mkUser(id) {
  return { id, name: id, email: id + '@t.t', passHash: 'x', salt: 'x', isAdmin: false, country: 'ru', status: '', createdAt: now, lastSeen: now, level: 75, xp: 0, dollars: 5e9, gold: 100000, bank: 0, skillPoints: 0, skills: { energy: 5, health: 5, ammo: 5, cruelty: 0, agility: 0 }, res: { hp: { cur: 150, t: now }, en: { cur: 150, t: now }, am: { cur: 10, t: now } }, units: { ground_1: { 0: 50 } }, workshops: 0, modernQueue: [], buildings: {}, secretDevs: {}, superSecret: 0, ears: 0, tokens: 0, crestPartsLost: 0, crestParts: 2, crestLostAt: [], earPenaltyUntil: 0, battle: { attacks: 0, wins: 0, losses: 0, defWins: 0, defLosses: 0, breaches: 0 }, counters: {}, achStages: {}, missions: {}, tutorial: { done: true }, effects: [], trophies: {}, club: {}, allianceId: null, legionId: null, lastIncomeAt: now, mines: [], minesSchemaV: M.SCHEMA_V, saboteurs: {}, saboteurLimits: {}, silos: [] };
}
