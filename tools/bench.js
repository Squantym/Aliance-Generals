...
for (let i = 0; i < N; i++) {
  ...
  um[id] = {
    ...
    battle: { breaches: 0, attacks: i % 50, wins: i % 30, losses: i % 20, defWins: 0, defLosses: 0 },
    ears: 0, crestPartsLost: 0, crestParts: 2, crestLostAt: [], earPenaltyUntil: 0,
    crestTakers: [null, null], crestMessage: null, missions: {}, achStages: {},
