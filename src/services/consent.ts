...
// 1.1 (11.09.2026) — существенная правка перед приёмом денег: в Правила
// платежей добавлены наборы и акции, в Правила игры — клуб офицеров со
// взносами и запрет сговора, раздел чеков переписан под самозанятого.
// Это изменение платного функционала (п. 11.2 Соглашения), поэтому
// обязательное согласие «terms» спрашивается заново: каждый, кто будет
// платить, должен принять именно эту редакцию. Политика ПДн уточнена
// (сроки журнала, push, копии) без новых целей — её версия поднята для
// учёта, но отдельного согласия к ней не привязано.
const DOCS: Record<string, DocInfo> = {
  terms:    { name: 'Пользовательское соглашение',        v: '1.1', at: '2026-09-11', url: '/terms.html',          kind: 'doc' },
  rules:    { name: 'Правила игры и модерации',           v: '1.1', at: '2026-09-11', url: '/rules.html',          kind: 'doc' },
  payments: { name: 'Правила платежей и возвратов',       v: '1.1', at: '2026-09-11', url: '/payments.html',       kind: 'doc' },
  privacy:  { name: 'Политика обработки персональных данных', v: '1.1', at: '2026-09-11', url: '/privacy.html',    kind: 'doc' },
