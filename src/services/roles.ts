...
const ZONE_RULES: Array<[RegExp, Zone]> = [
  ...
  // История состояния игрока — та же зона, что копии базы: это инструмент
  // восстановления, и он показывает содержимое аккаунта целиком
  [/^\/api\/admin\/player-history/,                 'database'],
];
