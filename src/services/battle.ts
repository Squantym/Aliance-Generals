...
function resolveDamage(atk: number, def: number): any {
  ...
  if (ratio >= 1.5) {
    ...
    // Атакующий доминирует. Верхняя граница 30 совпадает с ограничителем
    // ниже: раньше бросок давал максимум 28, и обещанный трофеем «крит
    // ×6 от базы» упирался в 168 вместо 180 — недостижимый потолок.
    dealt = u.rnd(24, 30);
  }
