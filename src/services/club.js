// ===================================================================
// src/services/club.js — «Клуб офицеров» (развлекательный центр)
...
// ---------- Армрестлинг ----------
function armWrestle(user, bet, notices) {
  const c = clubState(user);
  const now = Date.now();
...
module.exports = { view, answerRiddle, guessStart, guessTry, armWrestle };
