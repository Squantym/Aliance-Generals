// ===================================================================
// src/services/sanctions.js — система «Санкций» (заказы на игроков)
//
// Механика:
...
function store() { return db.load('sanctions', {}); }

// ── Объявить санкцию ──────────────────────────────────────────────
function declare(user, targetId, amount, notices) {
  ...
  const players = require('./player').users();
...
function checkPayout(hunter, target, hpAfter, maxHp, notices) {
...
module.exports = { declare, list, checkPayout, clearTarget, MIN_BOUNTY, HP_THRESHOLD_PCT };
