...
// ──────────────────────────────────────────────────────────────────
function applyGrant(target, body) {
...
// ──────────────────────────────────────────────────────────────────
function pushGiftPopup(target, grantedList, customNote) {
...
function grant(adminUser, body, notices) {
  ...
  pushGiftPopup(target, granted, customNote || null);
...
// ──────────────────────────────────────────────────────────────────
function grantAll(adminUser, body, notices) {
...
// ──────────────────────────────────────────────────────────────────
function claimGift(user, giftId) {
