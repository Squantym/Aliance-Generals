...
//     общий рейтинг;
//   • взнос 1 000 000 $, каждый живой из победившей команды получает
//     500 000 000 $; ничья — взнос возвращается; не вышедший на бой и
...
// Взнос и приз — решение владельца (18.09.2026): вход сделан дешёвым,
// чтобы бои собирались, приз остался крупным.
const ENTRY = 1e6;                      // взнос
const PRIZE = 5e8;                      // каждому живому победителю
