...
function registerRoutes(app: any) {
  ...
  app.add('GET', '/api/me', (req) => {
    ...
    return {
      ...
      //
      // Хвост /v2 обязателен: по голому адресу отдаётся панель первой
      // версии. Из восемнадцати разделов шестнадцать переписаны под
      // вторую, и вести сотрудника надо туда.
      staffPanel: (() => {
