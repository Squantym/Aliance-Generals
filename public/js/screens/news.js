...
(function () {
  ...
  App.screens.newsview = async (c, param) => {
    ...
    // Объявление прочитано — полоса над экраном больше не нужна. Раньше
    // она висела, пока не нажмут крестик: игрок открывал новость из самой
    // полосы, читал и видел её снова на каждом экране.
    App._markNewsSeen(p.id);
  };
