...
const CLUB = {
  ...
  //
  //    Чистый камень-ножницы-бумага против случайного бота — это 33% и
  //    никакого решения. Поэтому генерал играет по ПРИВЫЧКЕ: он реже
  //    повторяет род, которым только что проиграл. Игроку видна вся
  //    история дуэли, так что наблюдательный выигрывает чаще случайного.
  TACTIC_WINS_NEEDED: 3,          // до трёх побед, максимум пять раундов
  TACTIC_BOT_SWITCH_PCT: 65,      // с какой вероятностью генерал сменит проигравший род
