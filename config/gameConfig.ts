...
const CLUB = {
  ...
  //    Награда падает с каждой потраченной попыткой: вскрыл с первой —
  //    16 🪙, с шестой — 6 🪙. Плоские 20 🪙 не различали угадавшего с
  //    первого раза и дожавшего на последней попытке.
  SAFE_DIGITS: 4, SAFE_TRIES: 6,
  SAFE_REWARD_BASE: 18, SAFE_REWARD_STEP: 2, SAFE_REWARD_MIN: 6,
  SAFE_CD_FAIL_MIN: 6,
